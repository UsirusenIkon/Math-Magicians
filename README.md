...
## Setup
   - To clone my repository run this command `https://github.com/UsirusenIkon/Math-magicians.git`
...
## 🤝 Contributing
   ...
   - Feel free to check the [issues](https://github.com/UsirusenIkon/Math-magicians/issues) page.
...
## 📝 License
   - This project is [MIT](https://github.com/UsirusenIkon/Math-magicians/blob/feature/LICENSE) licensed.
